...
# SRTcs_divisor(dividend,divisor,inPar):
#
# DESCRIPTION
#    Model for the hardware algorithm of division with carry save adder.
# INPUT
#    Needs as inputs:
#       dividend    : as signed integer value.
#       divisor     : as signed integer value.
...
def SRTcs_divisor(dividend,divisor,inPar):
    #div by zero
    if (divisor==0):
        return "div0"
    #overflow condition
    ...
    #quotient=quotient/(2**(loop_iteration))
    res=[]
    res+=[quotient]
    res+=[s]
    return res

# SRT_divisor(dividend,divisor,inPar):
#
# DESCRIPTION
...
def SRT_divisor(dividend,divisor,inPar):
    #div by zero
    if (divisor==0):
        return "div0"
    #overflow condition
    ...
    #quotient=quotient//(2**(loop_iteration-1))
    s=s*(2**(inPar-loop_iteration-1))
    print(s)
    print(quotient)
